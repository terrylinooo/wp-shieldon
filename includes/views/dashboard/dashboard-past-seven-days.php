...
<div class="wpso-dashboard">
	...
	<div class="wpso-flex">
		...
		<div class="wpso-board">
			...
			<div class="board-field right">
				...
				<div class="note"><?php _e( 'Total pageviews last 7 days.', 'wp-shieldon' ); ?></div>
			</div>
		</div>
	...
	<div class="wpso-tabs">
		<ul>
			...
			<li class="is-active"><a href="<?php menu_page_url( 'shieldon-action-logs' ); ?>&tab=past_seven_days"><?php _e( 'Last 7 days', 'wp-shieldon' ); ?></a></li>
