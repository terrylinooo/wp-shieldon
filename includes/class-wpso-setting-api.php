<?php
/**
 * WP Shieldon Settings API wrapper class
 *
 * @author Terry Lin
 * @package Shieldon
 * @since 1.0.0
 ...
 *
 * Notice:
 * This script is modified a lot by Terry L. for WP Shieldon plugin use.
...
class WPSO_Setting_API {
	...
	function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'setting-api', SHIELDON_PLUGIN_URL . 'includes/assets/js/shieldon-setting-api.js', array( 'jquery' ), SHIELDON_PLUGIN_VERSION, true );
	}
	 ...
	 * @return void
	 */
	function set_sections( array $sections ): void {
	 ...
	 * @return void
	 */
	function add_section( array $section ): void {
	 ...
	 * @return void
	 */
	function set_fields( array $fields ): void {
	 ...
	 * @return array
	 */
	function sanitize_options( array $options ): array {
	 ...
	 */
	function get_sanitize_callback( string $slug = '' ) {
		if ( empty( $slug ) ) {
			return false;
		}
	 ...
	 * @return string
	 */
	function get_option( string $option, string $section, string $default = '' ): string {
	...
	function show_forms() {
		...
		<?php foreach ( $this->setting_sections as $form ) { ?>
