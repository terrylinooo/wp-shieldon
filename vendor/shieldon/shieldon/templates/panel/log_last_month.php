...
<div class="so-dashboard">
    ...
    <div class="so-flex">
        <div class="so-board">
            ...
            <div class="board-field right">
                ...
                <div class="note"><?php _e('panel', 'log_note_captcha_last_month', 'CAPTCHA statistic last month.'); ?></div>
            </div>
        </div>
        <div class="so-board">
            <div class="board-field left">
            ...
            <div class="board-field right">
                ...
                <div class="note"><?php _e('panel', 'log_note_pageview_last_month', 'Total pageviews last month.'); ?></div>
            </div>
        </div>
    ...
    <div class="so-tabs">
        <ul>
            ...
            <li class="is-active"><a href="<?php echo $page_url; ?>&tab=last_month"><?php _e('panel', 'log_label_last_month', 'Last month'); ?></a></li>
        </ul>
    </div>
