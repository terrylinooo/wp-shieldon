    ...
    <div class="so-flex">
        <div class="so-board">
            ...
            <div class="board-field right">
                ...
                <div class="note"><?php _e('panel', 'log_note_captcha_last_7_days', 'CAPTCHA statistic last 7 days.'); ?></div>
            </div>
        </div>
        <div class="so-board">
            <div class="board-field left">
            ...
            <div class="board-field right">
                ...
                <div class="note"><?php _e('panel', 'log_note_pageview_last_7_days', 'Total pageviews last 7 days.'); ?></div>
            </div>
        </div>
